  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      ...
      let embed3 = new MessageEmbed()
        ...
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n[Invite Team GalactasX](https://discord.com/api/oauth2/authorize?client_id=842010969764528159&permissions=8&scope=bot) • [Support Server](https://discord.gg/wjmueHSHeZ)`)
        .setImage("https://cdn.discordapp.com/attachments/832180255103385650/864897921111556106/201173413_866341743955269_1227472870529417108_n.png")
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`Team GX | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
      embed.setImage("https://cdn.discordapp.com/attachments/832180255103385650/864897921111556106/201173413_866341743955269_1227472870529417108_n.png");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
